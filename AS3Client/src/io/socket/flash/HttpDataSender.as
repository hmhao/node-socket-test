package io.socket.flash {
	...
	public class HttpDataSender extends EventDispatcher {
		...
		public function HttpDataSender(sendUrl:String) {
			_sendUrl = sendUrl;
			_requestHeaders = new Array(new URLRequestHeader("Content-Type", "text/plain;charset=UTF-8"), new URLRequestHeader("Pragma", "no-cache"), new URLRequestHeader("Cache-Control", "no-cache"));
		}
